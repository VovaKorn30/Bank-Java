...
public class AccountControllerRestTemplateTest {
    ...
    @Test
    @DisplayName("Успішний пошук рахунків усіх клієнтів")
    ...
    @Test
    @DisplayName("Успішний пошук по рахунку  по id")
    ...
    @Test
    @DisplayName("Рахунок по id не знайден: клиєнт не знайден")
    ...
    @Test
    @DisplayName("Рахунок по id не знайден: рахунок не знайден")
    ...
    @Test
    @DisplayName("Успешне додавання клієнта(без карт)")
    ...
    @Test
    @DisplayName("Неуспішне додавання рахунку  клиєнта: кліент не знайден")
    ...
    @Test
    @DisplayName("Неуспішне оновлення")
