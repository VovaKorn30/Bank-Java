...
@Api(description = "Контроллер для рахунків")
public class AccountController {
    ...
    @ApiOperation(value = "Отримати всі рахункі клієнтів")
    ...
    @ResponseStatus(HttpStatus.OK)
    @ApiOperation(value = "Отримати рахунок  по id")
    ...
    @ApiOperation(value = "Додати рахунок  (без карт)")
    ...
    @PutMapping("/card")
    @ResponseStatus(HttpStatus.OK)
    @ApiOperation(value = "Внести гроші на рахунок")
